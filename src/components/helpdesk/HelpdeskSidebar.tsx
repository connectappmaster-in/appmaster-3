...
import { LayoutDashboard, Ticket, Package, BookOpen, Clock, BarChart3, Plug, Settings, ChevronLeft } from "lucide-react";
...
const navItems = [
  ...
  { title: "SLA & Queues", url: "/helpdesk/sla", icon: Clock },
  { title: "Reports", url: "/helpdesk/reports", icon: BarChart3 },
  { title: "Integrations", url: "/helpdesk/integrations", icon: Plug },
